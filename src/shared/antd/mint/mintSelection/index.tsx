...
import LazyLoad, { forceCheck } from '@stream-protocol/react-lazyload'
...
const MintSelection = ({ value, onChange, style = {} }: MintSelectionProps) => {
  ...
  const onRefresh = useCallback(() => {
    const list = document.getElementById('stream-token-selection-list')
        ...
        <Row gutter={[32, 32]}>
          ...
          <Col span={24}>
            <Row
              ...
              style={{ maxHeight: 360 }}
              className="scrollbar"
              id="stream-token-selection-list"
            >
